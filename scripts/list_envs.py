...
importlib.import_module("robinion_gym.tasks")
...
def main() -> None:
    ...
    parser.add_argument("--keyword", default="RobinionGym-", help="Substring used to filter task ids.")
    ...
    table.title = "Available robinion_gym Environments"
